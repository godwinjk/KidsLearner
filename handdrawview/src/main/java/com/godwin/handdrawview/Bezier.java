...
/**
 * Created by Godwin on 12/17/2017 8:54 AM for DrawView.
 *
 * @author : Godwin Joseph Kurinjikattu
 *         <p>
 *         This class is used to geneerate a quadratic bezier curve with help of {@link TimePoint}.
 */
public class Bezier {
    ...
    public  Bezier set(TimePoint startPoint, TimePoint control1,
                       TimePoint control2, TimePoint endPoint) {
